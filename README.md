...
| Semantic duel model | 🔶 **In progress** | 29 of ~90 messages decoded, including bounded query-stream patches; no renderer involved — [design](docs/architecture/semantic-model.md) |
