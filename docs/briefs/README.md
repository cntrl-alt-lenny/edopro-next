...
| `accepted` | `archive/` | Verifier reviewed, Brain adjudicated, Brain merged (see [`docs/agents/CONSTITUTION.md`](../agents/CONSTITUTION.md), "Authority", for what still goes to the owner). |
