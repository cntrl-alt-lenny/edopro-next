...
and must not be treated as accepted. Re-land that branch as its own reviewed
round after this adoption round; do not build on its outcome here.
...
meanings: [`docs/agents/roles/worker.md`](../../agents/roles/worker.md).
...
The standard report in [`docs/agents/roles/worker.md`](../../agents/roles/worker.md), plus:
