...
**Accepted and merged 2026-09-20 at `d3b458bb`.** The adoption is deliberately
partial: the neutrality guard remains deferred and is not installed. The
canonical contracts, report/checkout tooling, Claude adapter and project
reconciliation were accepted after the C1-C8 correction passes.

**Outstanding wording nit recorded at close-out:** the non-goals phrase
“newly installed neutrality scanner” should have said “files adoption would
otherwise install.” The files were newly installed by the adoption and then
deliberately removed under C3; the wording did not change the intended scope.
